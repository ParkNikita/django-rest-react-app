    ...
    return (
        <div className='text-[15px] p-3 mb-5 border-2 border-grey-500 border-opacity-100'>
            ...
            <div>
                <div className='text-[15px] p-3 mb-5 border-2 border-grey-500 border-opacity-100'>
                <h2>Retweet</h2>
                <h2 className='font-bold'>@{props.tweet.parent.username}</h2>
                <p >{props.tweet.content}</p>
                <div className='btn'>
                    <MyButton action={'like'} className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 mt-5 px-3'>
                        {props.tweet.parent}
                    </MyButton>
                </div>
                </div>
            ...
            <div className='btn'>
                ...
                <button onClick={retweet} className='bg-white text-green-500 hover:bg-green-500 hover:text-white border border-grey border-opacity-1000 font-bold py-2 px-3'>
                    Retweet
                </button>
            </div>
        </div>
